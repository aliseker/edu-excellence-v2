...
const Hero = () => {
  return (
    <section className="relative bg-white overflow-hidden border-b-4 border-purple-600">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12 z-20">
        <div className="max-w-5xl">
          {/* Content - Animated from right */}
          <div className="space-y-5 animate-slide-in-right">
            {/* Badge - Geometric Style */}
            <div className="inline-flex items-center px-5 py-2.5 bg-purple-600 text-white font-bold text-sm uppercase tracking-wider border-4 border-purple-800 transform -skew-x-12 shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/basvuru"
                className="px-9 py-4 bg-white text-purple-600 font-black text-base uppercase tracking-wider border-4 border-purple-600 hover:bg-purple-50 transition-all duration-200 shadow-[8px_8px_0_0_rgba(147,51,234,0.3)] hover:shadow-[4px_4px_0_0_rgba(147,51,234,0.3)] hover:translate-x-1 hover:translate-y-1"
              >
                Hemen Başvur
              </Link>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-5">
              <div className="bg-purple-600 text-white p-5 border-4 border-purple-800 shadow-lg transform -skew-x-3">
                <div className="transform skew-x-3">
                  <div className="text-3xl font-black mb-1">15+</div>
                  <div className="text-xs font-bold uppercase tracking-wider">Yıllık Deneyim</div>
                </div>
              </div>
              <div className="bg-violet-600 text-white p-5 border-4 border-violet-800 shadow-lg transform -skew-x-3">
                <div className="transform skew-x-3">
                  <div className="text-3xl font-black mb-1">300+</div>
                  <div className="text-xs font-bold uppercase tracking-wider">Anlaşmalı Okul</div>
                </div>
              </div>
              <div className="bg-pink-600 text-white p-5 border-4 border-pink-800 shadow-lg transform -skew-x-3">
                <div className="transform skew-x-3">
                  <div className="text-3xl font-black mb-1">30+</div>
                  <div className="text-xs font-bold uppercase tracking-wider">Ülke</div>
                </div>
              </div>
            </div>
          </div>
