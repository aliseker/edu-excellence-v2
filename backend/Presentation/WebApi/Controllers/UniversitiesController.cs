...
public class UniversitiesController : ControllerBase
{
    ...
    [HttpPost]
    [Authorize]
    public async Task<IActionResult> Create([FromBody] UniversityCreateUpdateDto dto)
    {
    ...
    [HttpPut("{id:int}")]
    [Authorize]
    public async Task<IActionResult> Update(int id, [FromBody] UniversityCreateUpdateDto dto)
    {
