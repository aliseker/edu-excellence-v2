...
export default function IletisimPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white py-6 border-b-4 border-gray-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-3 sm:px-4 lg:px-5 z-10">
          <div className="inline-block px-3 py-1.5 bg-white/20 backdrop-blur-sm border-4 border-white/30 transform -skew-x-12 mb-3">
            <span className="transform skew-x-12 text-[10px] font-black uppercase tracking-wider">📧 İletişim</span>
          </div>
          <h1 className="text-xl md:text-2xl lg:text-3xl font-black mb-2 leading-tight drop-shadow-[4px_4px_0_rgba(0,0,0,0.3)]">
            BİZE ULAŞIN
            <br />
          ...
          <p className="text-sm md:text-base text-purple-100 font-medium max-w-2xl">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:info@eduexcellence.com.tr" className="text-gray-700 font-bold text-lg hover:text-purple-600 transition-colors">
                      info@eduexcellence.com.tr
                    </a>
                  </div>
                </div>
              </div>
